...
const Contact = () => {
  const WEB3FORMS_ACCESS_KEY =
    ...
    "ee324335-5c7a-47cb-a34a-ea5bace6295d";
          ...
          <div className="bg-white dark:bg-gray-800/50 p-8 rounded-3xl border-2 border-gray-200 dark:border-gray-700 shadow-xl">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {result && (
                  <span className="block text-sm text-center text-gray-600 dark:text-gray-300">
                    {result}
                  </span>
                )}
              </form>
            ...
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 p-8 rounded-3xl shadow-xl text-white">
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  ...
                  className="flex items-center gap-3 bg-white/20 hover:bg-white/30 backdrop-blur-sm p-4 rounded-xl transition-all duration-300 transform hover:scale-105"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
        ...
        <div className="bg-white dark:bg-gray-800/50 p-8 rounded-3xl border-2 border-gray-200 dark:border-gray-700 shadow-xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-gray-50 dark:bg-gray-900/50 rounded-2xl">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our parking system operates 24/7, but support is available
            ...
            <div className="p-6 bg-gray-50 dark:bg-gray-900/50 rounded-2xl">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Yes! Please schedule an appointment before visiting.
              </p>
            </div>
            <div className="p-6 bg-gray-50 dark:bg-gray-900/50 rounded-2xl">
              <h3 className="text-lg font-bold mb-2 text-gray-900 dark:text-white">
